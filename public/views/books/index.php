    ...
    <tbody>
      <?php foreach ($books as $book) { ?>
        <tr>
          ...
          <td><a href="/final/books/<?php echo $book->getId() ?>">詳細</a></td>
          <td><a href="/final/books/<?php echo $book->getId() ?>/edit">編集</a></td>
          <td><a href="/final/books/<?php echo $book->getId() ?>/delete">削除</a></td>
          <td>
